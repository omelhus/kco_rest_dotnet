...
namespace Klarna.Rest.Models
{
    ...
    public class CheckoutOrderData : Model
    {
        ...
        /// <summary>
        ///     Gets or sets the merchant reference 1, can be used for storing merchant's internal order number or other
        ///     references.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the merchant reference 2, can be used for storing merchant's internal order number or other
        ///     references.
        /// </summary>
